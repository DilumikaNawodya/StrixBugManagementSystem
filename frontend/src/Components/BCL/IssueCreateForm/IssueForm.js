      ...
      <Form onSubmit={formik.handleSubmit}>
        <Form.Group>
          ...
          {formik.errors.project && formik.touched.project ? (
            <Form.Text style={warningstyle}>{formik.errors.project}</Form.Text>
          ) : null}
        </Form.Group>
        ...
        <Form.Group>
          ...
          {formik.errors.title && formik.touched.title ? (
            <Form.Text style={warningstyle}>{formik.errors.title}</Form.Text>
          ) : null}
        </Form.Group>
        ...
        <Form.Group>
          ...
          {formik.errors.summary && formik.touched.summary ? (
            <Form.Text style={warningstyle}>{formik.errors.summary}</Form.Text>
          ) : null}
        </Form.Group>
        {/* Resulting output */}
        {/* <Form.Group>
